...
const SchedulePage = () => {
  ...
  const scheduleData = {
    ...
    "1Г": {
      "Понедельник": [
        { time: "8:30 - 9:15", subject: "Русский язык", room: "103" },
        { time: "9:25 - 10:10", subject: "Математика", room: "103" },
        { time: "10:30 - 11:15", subject: "Окружающий мир", room: "103" },
        { time: "11:35 - 12:20", subject: "Физкультура", room: "Спортзал" }
      ],
      "Вторник": [
        { time: "8:30 - 9:15", subject: "Математика", room: "103" },
        { time: "9:25 - 10:10", subject: "Чтение", room: "103" },
        { time: "10:30 - 11:15", subject: "ИЗО", room: "103" },
        { time: "11:35 - 12:20", subject: "Музыка", room: "102" }
      ],
      "Среда": [
        { time: "8:30 - 9:15", subject: "Русский язык", room: "103" },
        { time: "9:25 - 10:10", subject: "Математика", room: "103" },
        { time: "10:30 - 11:15", subject: "Технология", room: "103" },
        { time: "11:35 - 12:20", subject: "Физкультура", room: "Спортзал" }
      ],
      "Четверг": [
        { time: "8:30 - 9:15", subject: "Чтение", room: "103" },
        { time: "9:25 - 10:10", subject: "Русский язык", room: "103" },
        { time: "10:30 - 11:15", subject: "Математика", room: "103" },
        { time: "11:35 - 12:20", subject: "Окружающий мир", room: "103" }
      ],
      "Пятница": [
        { time: "8:30 - 9:15", subject: "Русский язык", room: "103" },
        { time: "9:25 - 10:10", subject: "Математика", room: "103" },
        { time: "10:30 - 11:15", subject: "Чтение", room: "103" },
        { time: "11:35 - 12:20", subject: "Физкультура", room: "Спортзал" }
      ]
    },
    "5Г": {
      "Понедельник": [
        { time: "8:30 - 9:15", subject: "Русский язык", room: "206" },
        { time: "9:25 - 10:10", subject: "Математика", room: "206" },
        { time: "10:30 - 11:15", subject: "История", room: "208" },
        { time: "11:35 - 12:20", subject: "Английский язык", room: "303" },
        { time: "12:40 - 13:25", subject: "Физкультура", room: "Спортзал" }
      ],
      "Вторник": [
        { time: "8:30 - 9:15", subject: "Математика", room: "206" },
        { time: "9:25 - 10:10", subject: "Русский язык", room: "206" },
        { time: "10:30 - 11:15", subject: "Английский язык", room: "303" },
        { time: "11:35 - 12:20", subject: "География", room: "210" },
        { time: "12:40 - 13:25", subject: "Биология", room: "215" }
      ],
      "Среда": [
        { time: "8:30 - 9:15", subject: "Литература", room: "206" },
        { time: "9:25 - 10:10", subject: "Математика", room: "206" },
        { time: "10:30 - 11:15", subject: "Информатика", room: "309" },
        { time: "11:35 - 12:20", subject: "ИЗО", room: "207" },
        { time: "12:40 - 13:25", subject: "Технология", room: "110" }
    ...
    "9Г": {
      "Понедельник": [
        { time: "8:30 - 9:15", subject: "Алгебра", room: "308" },
        { time: "9:25 - 10:10", subject: "Русский язык", room: "308" },
        { time: "10:30 - 11:15", subject: "Физика", room: "312" },
        { time: "11:35 - 12:20", subject: "Английский язык", room: "304" },
        { time: "12:40 - 13:25", subject: "История", room: "208" },
        { time: "13:35 - 14:20", subject: "Химия", room: "315" }
      ],
      "Вторник": [
        { time: "8:30 - 9:15", subject: "Геометрия", room: "308" },
        { time: "9:25 - 10:10", subject: "Литература", room: "308" },
        { time: "10:30 - 11:15", subject: "Информатика", room: "309" },
        { time: "11:35 - 12:20", subject: "Биология", room: "215" },
        { time: "12:40 - 13:25", subject: "География", room: "210" },
        { time: "13:35 - 14:20", subject: "Физкультура", room: "Спортзал" }
      ...
      "Пятница": [
        ...
        { time: "11:35 - 12:20", subject: "Английский язык", room: "304" },
        { time: "12:40 - 13:25", subject: "География", room: "210" },
        { time: "13:35 - 14:20", subject: "Родной язык", room: "308" }
      ],
      "Суббота": [
        { time: "8:30 - 9:15", subject: "Физика", room: "312" },
        { time: "9:25 - 10:10", subject: "Литература", room: "308" },
        { time: "10:30 - 11:15", subject: "Проектная деятельность", room: "308" },
        { time: "11:35 - 12:20", subject: "Подготовка к ОГЭ (матем.)", room: "308" }
      ]
    },
    "11Г": {
      "Понедельник": [
        { time: "8:30 - 9:15", subject: "Алгебра", room: "309" },
        { time: "9:25 - 10:10", subject: "Русский язык", room: "309" },
        { time: "10:30 - 11:15", subject: "Физика", room: "312" },
        { time: "11:35 - 12:20", subject: "Английский язык", room: "305" },
        { time: "12:40 - 13:25", subject: "История", room: "209" },
        { time: "13:35 - 14:20", subject: "Астрономия", room: "312" }
      ],
      "Вторник": [
        { time: "8:30 - 9:15", subject: "Геометрия", room: "309" },
        { time: "9:25 - 10:10", subject: "Литература", room: "309" },
        { time: "10:30 - 11:15", subject: "Информатика", room: "310" },
        { time: "11:35 - 12:20", subject: "Биология", room: "216" },
        { time: "12:40 - 13:25", subject: "Обществознание", room: "209" },
        { time: "13:35 - 14:20", subject: "Физкультура", room: "Спортзал" }
      ...
      "Пятница": [
        ...
        { time: "11:35 - 12:20", subject: "Английский язык", room: "305" },
        { time: "12:40 - 13:25", subject: "Обществознание", room: "209" },
        { time: "13:35 - 14:20", subject: "Индивидуальный проект", room: "309" }
      ],
      "Суббота": [
        { time: "8:30 - 9:15", subject: "Химия", room: "315" },
        { time: "9:25 - 10:10", subject: "Биология", room: "216" },
        { time: "10:30 - 11:15", subject: "Подготовка к ЕГЭ (матем.)", room: "309" },
        { time: "11:35 - 12:20", subject: "Подготовка к ЕГЭ (рус.яз.)", room: "309" }
      ]
    }
  };
  ...
  classList.forEach(className => {
    if (!scheduleData[className]) {
      ...
      if (level === "1" || level === "2" || level === "3" || level === "4") {
        template = letter === "Г" ? scheduleData["1Г"] : scheduleData["1А"];
      } else if (level === "5" || level === "6" || level === "7" || level === "8") {
        template = letter === "Г" ? scheduleData["5Г"] : scheduleData["5А"];
      } else if (level === "9") {
        template = letter === "Г" ? scheduleData["9Г"] : scheduleData["9А"];
      } else {
        template = letter === "Г" ? scheduleData["11Г"] : scheduleData["11А"];
      }
