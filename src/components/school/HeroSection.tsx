...
const HeroSection = () => {
  return (
    <div className="relative bg-primary/5 py-16 md:py-24 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-lg mb-6 text-muted-foreground">
              Мы создаем образовательную среду, где каждый ученик может раскрыть свой потенциал 
              и добиться успеха.
            </p>
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              <Button asChild size="lg">
                <Link to="/about">О нашей школе</Link>
              </Button>
          ...
          <div className="relative mt-8 md:mt-0">
            ...
            <div className="absolute -bottom-4 -right-4 bg-secondary text-secondary-foreground p-4 rounded-lg shadow-lg">
              <p className="font-bold">Набор в 1 класс открыт!</p>
      ...
      <div className="hidden md:block absolute top-0 right-0 w-48 h-48 bg-secondary/20 rounded-full -translate-y-1/2 translate-x-1/3 blur-3xl"></div>
